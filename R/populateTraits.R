...
#' @param trait_mapping A named list specifying which trait data column should used to populate each medfate param. Elements are data base columns and names are medfate params.
#' @param transformation_functions A named list of scalar functions for traits needing transformation of units or scaling.
